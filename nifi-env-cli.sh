...
""
"Commands:"
"  scale            ./nifi-env-cli scale <SERVICE> <NUMBER_OF_INSTANCES> - It will scale containers of available servers"
"  start            ./nifi-env-cli start                                 - It will start the NiFi environment"
"  stop             ./nifi-env-cli stop                                  - It will start the NiFi environment"
""
""
"Options:"
"  --help, -h               Print help."
