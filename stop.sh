...
function usage() {
  local txt=(
    "Utility $SCRIPT for stop the NiFi workshop environment."
    "Usage: $SCRIPT [options] <command> [arguments]"
    ""
    "Commands:"
    "  all             nifi-workshop-cli stop all - It will stop the whole env"
    "  nifi            nifi-workshop-cli stop nifi - It will stop only NiFi"
    "  services        nifi-workshop-cli stop services - It will stop all services around NiFi"
    "  monitoring      nifi-workshop-cli stop monitoring - It will stop only Grafana and Prometheus"
    "- Note: You can combine commands like: nifi-workshop-cli stop nifi monitoring"
    ""
    ""
    "Options:"
    "  --help, -h               Print help."
